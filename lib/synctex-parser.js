  ...
  for (var i = 1; i < lineArray.length; i++) {
    ...
    if (match) {
      ...
      var elem = {
        ...
        // Patched: upstream synctex-js assumes every fileNumber referenced by
        // an element was already registered via an "Input:" line, which
        // doesn't hold for every multi-file (\input/\include) document —
        // fall back instead of crashing the whole parse.
        file: files[fileNumber] || { path: '', name: '' },
        line: lineNumber,
        left: left,
        bottom: bottom,
